...
document.getElementById("calculate").addEventListener("click", (event) => {
    try {
        ...
        if(Object.keys(store.input).length === 0) { alert("Please add a json file or select a test data set, by clicking on one of the buttons below, to start calculation."); }
