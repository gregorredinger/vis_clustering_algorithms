...
- Webpack reports error during module bundling --> delete node_modules folder and run "npm update" in terminal
...
- Webpack don't update my bundle.js code / the browser don't reflect the changes I made to the Code -->
 ...
 1. check if you haven't closed the terminal Window where webpack runs after typing npm run build,
 ...
 2. clear the cache of the Browser, you can make this process easier by using Plugins e.g. search for "Clear Cache Chrome Plugin"
